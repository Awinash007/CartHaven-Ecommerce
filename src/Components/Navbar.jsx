        ...
        <>
                ...
                <div className="row gx-0 d-none d-lg-flex">
                    <div className="col-lg-7 px-5 text-start">
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            ...
                            <Link to="mailto:mailtoawi@gmail.com" target='_blank' rel='noreferrer'>mailtoawi@gmail.com</Link>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-phone text-primary me-2"></small>
                            <Link to="tel:+919031842124" target='_blank' rel='noreferrer'>+91-9031842124</Link>
                        </div>
                        <div className="h-100 d-inline-flex align-items-center py-3 me-4">
                            <small className="fa fa-whatsapp text-primary me-2"></small>
                            <Link to="https://wa.me/+919031842124" target='_blank' rel='noreferrer'>+91-9031842124</Link>
                        </div>
                    </div>
            ...
            >
                <Link to="/" className="navbar-brand p-0">
                    ...
                    <h1 className="m-0 text-primary">CartHaven</h1>
                </Link>
                <button
                    type="button"
