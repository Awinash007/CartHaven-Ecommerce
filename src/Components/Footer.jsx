                    ...
                    <div className="row g-5">
                        <div className="col-lg-4 col-md-6">
                            ...
                            <Link className="mb-2 text-light d-block" to="tel:+919873848036">
                                <i className="fa fa-phone me-3"></i>+91-9031842124
                            </Link>
                            <Link className="mb-2 text-light d-block" to="mailto:mailtoawi@gmail.com">
                                <i className="fa fa-envelope me-3"></i>mailtoawi@gmail.com
                            </Link>
                    ...
                    <div className="copyright">
                        <div className="row">
                            <div className="col-md-6 text-center text-md-start mb-3 mb-md-0">
                                &copy; <a className="border-bottom" href="#">CartHaven</a>, All
                                Right Reserved.
                            </div>
                        </div>
                    </div>
